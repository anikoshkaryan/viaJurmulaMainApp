        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <View style={styles.back_to_btn_password_recovery_title_wrapper}>
                    <TouchableOpacity style={styles.back_to_btn} onPress={()=>this.redirectToSignIn()}>
                ...
                <TouchableOpacity style={styles.send_phone_number_btn} onPress={()=>this.sendCode()}>
                    <Text style={styles.send_phone_number_btn_text}>
                        {i18n.t('send')}
                    </Text>
                </TouchableOpacity>
