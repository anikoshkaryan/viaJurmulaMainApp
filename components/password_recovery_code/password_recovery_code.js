...
export default class App extends Component {
    ...
    backToPasswordRecoveryPhone = () => {
        this.props.navigation.navigate("PasswordRecoveryPhone");
    }

    verifyCode = () => {
        // this.props.navigation.navigate("PasswordRecoveryNewPassword");

        let code1_valid = this.state.code1_field_valid;
        let code2_valid = this.state.code2_field_valid;
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <View style={styles.back_to_btn_password_recovery_title_wrapper}>
                    <TouchableOpacity style={styles.back_to_btn} onPress={()=>this.backToPasswordRecoveryPhone()}>
                ...
                <View style={styles.verify_code_already_send_text_parent}>
                    <Text style={styles.verify_code_already_send_text}>{i18n.t('verify_code')} {this.state.securedPhone}</Text>
                </View>

                <View style={styles.code_inputs_wrapper}>
                    <TextInput
                        ref='firstInput'
                ...
                <TouchableOpacity style={styles.verify_phone_number_btn}  onPress={()=>this.verifyCode()}>
                    <Text style={styles.verify_phone_number_btn_text}>{i18n.t('verify')}</Text>
                </TouchableOpacity>

                <View style={styles.did_not_receive_text_parent}>
                    <Text style={styles.did_not_receive_text}>{i18n.t('receive_text')}</Text>
                    <TouchableOpacity style={styles.resend_btn}>
                        <Text style={styles.resend_btn_text}>{i18n.t('resend')}</Text>
                    </TouchableOpacity>
                </View>
