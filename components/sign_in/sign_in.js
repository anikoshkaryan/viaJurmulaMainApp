...
export default class App extends Component {
    ...
    redirectToPasswordRecoveryPhone = () => {
    ...
    signInHandler = () => {
        ...
        let password= this.state.password_field_valid;
        if(email === true && password === true) {
            let email_value = this.state.email_field;
            let password_value = this.state.password_field;
            ...
            axios.post("http://vjapp.reproto.com/api/login", req).then(
                (response) => {
    ...
    render() {
        ...
        return (
            <SafeAreaView style={styles.container} >
                    ...
                    <View style={styles.sign_in_inputs_main_wrapper}>

                            <View style={styles.back_to_dashboard_page_btn_sign_in_title_wrapper}>
                                <TouchableOpacity style={styles.back_to_dashboard_page_btn}
                                                  onPress={() => this.redirectToDashboard()}>
                                    <View style={styles.back_to_dashboard_page_btn_icon}>
                                        <Svg
                                    ...
                                    <Text style={styles.back_to_dashboard_page_btn_text}>{i18n.t('back')}</Text>
                                </TouchableOpacity>
                                ...
                                <KeyboardAwareScrollView enableOnAndroid={true} style={{paddingHorizontal: 20}}>
                                    ...
                                    <View style={styles.sign_in_inputs_wrapper}>
                                        <View style={styles.inputWrapper}>
                                            ...
                                            {this.state.email_field_error && this.state.email_field_error_text != "" &&
                                        ...
                                        <View style={styles.inputWrapper}>
                                            ...
                                            {this.state.password_field_error && this.state.password_field_error_text != "" &&
                                        ...
                                        {this.state.login_validation_error &&

                                        <Text style={styles.error_text2}>
                                            {i18n.t('login_validation_error_message')}
                                        </Text>

                                        }


                                        <TouchableOpacity style={styles.forget_password_btn} onPress={() => {
                                            this.redirectToPasswordRecoveryPhone()
                                        }}>
                                            <Text style={styles.forget_password_btn_text}>
                                        ...
                                        <TouchableOpacity style={styles.sign_in_btn} onPress={() => {
                                            ...
                                            <Text style={styles.sign_in_btn_text}>
                                                {i18n.t('sign_in')}
                                            </Text>
                                        </TouchableOpacity>
                                    </View>
...
const styles = StyleSheet.create({
    ...
    back_to_dashboard_page_btn: {
       flexDirection: "row",
        alignItems: "center",
        justifyContent: "flex-start",
    },
    back_to_dashboard_page_btn_text: {
        fontSize: 12,
        color: "#000000",
        fontWeight: 'bold',
    },
